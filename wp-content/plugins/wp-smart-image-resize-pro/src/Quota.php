...
final class Quota
{
    ...
    public static function show_quota_status()
    {
      ...
      <div class="wpsirQuotaStatus">
        ...
        <span><?php echo self::get_consumed() ?> изображение(ий) <?php echo self::get_initial_credits() ?> обработано ( <a target="_blank" href="https://sirplugin.com/#pro">Upgrade to PRO</a> для неограниченного количества изображений ).</span>
