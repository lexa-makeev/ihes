...
= 1.7.0 = Released on 04 March 2021

* New: support for WordPress 5.7
* New: support for WooCommerce 5.1
* New: compatibility with "Facebook for WooCommerce" plugin by Facebook
* Tweak: added 'product' parameter to 'yith_wacp_continue_shopping_url' filter
* Update: YITH plugin framework
* Fix: prevent double click on actions buttons in Safari browser
* Dev: new filter 'yith_wacp_is_in_exclusion'

= 1.6.6 = Released on 02 February 2021

* New: support for WooCommerce 5.0
* Update: YITH plugin framework
* Dev: new filter 'yith_wacp_discount_label'

= 1.6.5 = Released on 12 January 2021

* New: Support for WooCommerce 4.9
* New: Compatibility with WooCommerce Quickview plugin by Iconic
* Update: Plugin framework
* Update: Language files
* Fix: Force cart layout if product object is not set

= 1.6.4 = Released on 03 December 2020

* New: Support for WooCommerce 4.8
* Update: Plugin framework
* Update: Language files
* Dev: New filter 'yith_wacp_load_popup_template'
* Tweak: Set no cache for update mini cart AJAX request

= 1.6.3 = Released on 02 November 2020
...
= 1.6.2 = Released on 12 October 2020

* New: Support for WooCommerce 4.6.x
* New: Compatibility with "Food Online Premium" plugin
* Update: Plugin framework
* Update: Language files
* Fix: Button animation issue on Safari and Apple mobile devices
* Tweak: Show zero amount in case of free taxes

= 1.6.1 = Released on 18 September 2020

* New: Support for WooCommerce 4.5
* Update: Plugin framework
* Update: Language files
* Tweak: Use plugin icons in svg format

= 1.6.0 = Released on 14 August 2020

* New: Support for WooCommerce 4.4
* New: Support for WordPress 5.5
* Update: Plugin framework
* Update: Language files
* Dev: New filter 'yith_wacp_hide_mini_cart'
* Dev: New filter 'yith_wacp_continue_shopping_text'
