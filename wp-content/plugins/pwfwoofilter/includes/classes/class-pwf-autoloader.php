...
class Pwf_Autoloader {
	...
	private function get_autoload_classes() {
		$classes = array(
			...
			'pwf_admin_analytic_query'          => PWF_WOO_FILTER_DIR . 'includes/admin/class-pwf-admin-analytic-query.php',
			'pwf_elementor_pro'                 => PWF_WOO_FILTER_DIR . 'includes/compitable-plugins/elementor-pro/class-pwf-elementor-pro.php',
			'pwf_powerpack_elements'            => PWF_WOO_FILTER_DIR . 'includes/compitable-plugins/powerpack-elements/class-pwf-powerpack-elements.php',
			...
			'pwf_db_utilities'                  => PWF_WOO_FILTER_DIR . 'includes/classes/class-pwf-db-utilities.php',
			'pwf_analytic_query'                => PWF_WOO_FILTER_DIR . 'includes/classes/class-pwf-analytic-query.php',
			'pwf_integrate_shortcode'           => PWF_WOO_FILTER_DIR . 'includes/classes/class-pwf-integrate-shortcode.php',
			'pwf_api_prepare_filter_post'       => PWF_WOO_FILTER_DIR . 'includes/classes/class-pwf-api-prepare-filter-post.php',
		);
